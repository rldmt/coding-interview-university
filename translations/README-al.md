...
- [Albanian (Shqip)](https://github.com/jwasham/coding-interview-university/issues/419)
...
- [Çfarë nuk do mbulojë ky plan?](#çfarë-nuk-do-mbulojë-ky-plan)
...
- [Më shumë njohuri](#më-shumë-njohuri)
    - [Kërkimi binar](#kërkimi-binar)
    - [Veprime bitwise](#veprime-bitwise)
- [Pemët](#pemët)
    - [Pemët - Shënime dhe Baza](#pemët---shënime-dhe-baza)
    - [Kërkimi binar në pemë ose KBP](#këçrkimi-binar-në-peme-ose-kbp)
    - [Shkurret / Radhët me prioritet / Shkurret Binare](#shkurret--radhët-me-prioritet--shkurret-binare)
...
- [Më shumë njohuri](#më-shumë-njohuri)
    ...
    - [Programimi i orientuar me objekte](#programimi-i-orientuar-me-objekte)
    - [Paterna Dizenjimi](#paterna-dizenjimi)
    - [Kombinatorika n mbi k dhe Probabiliteti](#kombinatorika-n-mbi-k-dhe-probabiliteti)
    - [NP, NP-e Plotë dhe Algoritme Rrumbullakosje](#np-np-e-plote-dhe-algoritma-rrumbullakosje)
    - [Cache-të](#cashe-të)
    - [Proçeset dhe Threadet](#proçeset-dhe-threadet)
    - [Testimi](#testimi)
    - [Skedulimi](#skedulimi)
    - [Kërkimi dhe manipulimi i stringjeve](#kërkimi-dhe-manipulimi-i-stringjeve)
    - [Provat](#provat)
    - [Numrat Float me presje dhjetore](#numra-presje-dhjetore)
    - [Unicode](#unicode)
    - [Skajet ose (Endianness)](#skajet-endianness)
- [Rrjetat](#rrjetat)
- [Dizenjim Sistemesh, Skalabiliteti, Përdorimi i të dhënave](#dizenjim-sistemesh-skalabilitet-përdorimi-i-të-dhënave) (nëse ke mbi 4 vjet eksperiencë)
- [Rishikimi i fundit](#rishikimi-i-fundit)
- [Pyetje rreth Praktikave të Kodimit](#pyetje-rreth-praktikave-të-kodimit)
- [Ushtrime Kodimi](#ushtrime-kodimi)
- [Kur je afër intervistës](#kur-je-afër-intervistës)
- [Jetëshkrimi Juaj](#jetëshkrimi-juaj)
- [Mendime përpara intervistës](#mendime-përpara-intervistës)
- [Pyetjet që duhet t'i bëni intervistuesit](#pyetje-që-duhet-t--i-bëni-intervistuesit)
- [Pasi je pranuar në punë](#pasi-je-pranuar-në-punë)
...
- [Libra Shtesë](#libra-shtesë)
- [Tema Shtesë](#tema-shtesë)
    - [Kompilatorët](#kompilatorët)
    - [Emacs dhe vi(m)](#emacs-dhe-vim)
    - [Mjetet e komandava në Unix](#mjetet-e-komandave-në-unix)
    - [Teori informacioni](#teori-informacioni)
    ...
    - [Pemët van Emde Boas](#pemët-van-emde-boas)
    - [Struktura të dhënash të zgjeruara](#struktura-të-dhënash-të-zgjeruara)
    - [Kërkimi Binar i Pemëve i Balancuar](#kerkimi-binar-peme-balancuar)
        ...
        - Pemët B
    - [Pemët k-D](#pemet-k-d)
    - [Listat me kapërcim](#listat-me-kapërcim)
...
Kur e fillova këtë projekt, nuk e dija dallimin mes stivës dhe shkurres, nuk dija asgjë rreth Big-O, asgjë rreth pemëve , apo 
se si të shëtisim një graf. Nëse duhet kodoja një algoritëm sortimi, mund t'ju them se nuk isha shumë i mirë.
Çdo strukturë të dhëne që kisha përdorur ishte e ndërtuar brenda në gjuhën e programimit në të cilën po punoja, dhe nuk 
dija bazat pas këtyre strukturave. Nuk më është dashur asnjëherë të menaxhoj memorien, përjashtim ishin vetëm ato raste kur më
dilte "error" i tipit "out of memory". Zakonisht gjeja një rrugëdalje duke bërë "fashime" të këtyre problemeve. Kam përdorur 
vektorë multidimensionalë gjatë karrierës sime dhe me mijra vektorë asociativë, por kurrë të krijoj një të tillë nga fillimi. 

Plani është i madh. Do të kërkojë disa muaj kohë. Nëse je familiar me shumë nga temat e përmendura atëherë mund t'ju duhet më pak kohë.

## Si ta përdor?

<details>
<summary>Si ta përdor?</summary>

Çdo gjë më poshtë është një përmbledhje, dhe këshillohet të merren temat me radhë nga fillimi në fund.

Aktualisht është vënë në punë funksioni markdown i Github-it, përfshirë dhe detyrat individuale për të kontrolluar progresin e kryer.

**Krijo një branch të ri që të shikosh temat individuale. Ato tema që kryhen vendosi një x në kllapa katrore: [x]**


    Fork një branch dhe më pas ndiq komandat e mëposhtme
...
`git fetch --all`
    ...
    Bëj me X kutitë pasi ke bërë ndryshimet e tua
...
[Më shumë rreth funksionalitetit markdown të Github-it](https://guides.github.com/features/mastering-markdown/#GitHub-flavored-markdown)
...
<details>
<summary>Njohuri paraprake</summary>

- [ ] **Mëso gjuhën C**
    - C është kudo. Do të shohësh shembuj në libra, leksione, video, *kudo* që të studiosh.
    - [ ] [C Programming Language, Vol 2](https://www.amazon.com/Programming-Language-Brian-W-Kernighan/dp/0131103628)
        - Ky është një libër i shkurtër, por do të japë një kuptim të mirë të gjuhës C dhe në qoftë se e praktikon pak ti mund të bëhesh proefiçent. Të kuptosh gjuhën C do të thotë të kuptosh se si programet dhe memoria punon.
        - [përgjigje pyetjeve](https://github.com/lekkas/c-algorithms)

- [ ] **Si kompjuteri proçeson një program:**
    - [ ] [Si ekzekuton CPU një program (video)](https://www.youtube.com/watch?v=XM4lGflQFvA)
    - [ ] [Si llogarisin kompjuterat - ALU (video)](https://youtu.be/1I5ZMmrOfnA)
    - [ ] [Regjistrat dhe RAM-i (video)](https://youtu.be/fpnE6UAfbtU)
    - [ ] [Njësia Qëndrore e Proçesimit (CPU) (video)](https://youtu.be/FZGugFqdr60)
    - [ ] [Programet dhe Instruksionet (video)](https://youtu.be/zltgXvg6r3k)
